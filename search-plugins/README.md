...
```bash
bin/elasticsearch-plugin install file:///path/to/mecab-ko-analyzer-0.7.0.zip
```

### OpenSearch

```bash
bin/opensearch-plugin install file:///path/to/opensearch-analysis-mecab-ko-0.7.0.zip
```
