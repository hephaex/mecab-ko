...
| 지표 | garu | mecab-ko |
|---|---|---|
| 모델/사전 크기 | 1MB (코드북) | 159M (컴파일 사전) |
| WASM 바이너리 | 337KB | 86KB |
| 보고 정확도 (자체셋) | F1 95.3% (v15k), F1 93.9% (NIKL MP) | Token Acc. 100% (자체셋, 1,149 pass) |
...
- **garu**: F1(정밀도/재현율) 기준, 자체 v15k 골드(95.3%) 및 NIKL MP(93.9%)에서 보고.
