...
| 지표 | garu | mecab-ko |
|---|---|---|
| 모델/사전 크기 | 1.4MB (코드북) | N/A (컴파일 사전) |
| WASM 바이너리 | 401KB | N/A |
| 보고 정확도 (자체셋) | F1 95.8% (v15k), F1 N/A (NIKL MP) | Token Acc. 100% (자체셋, 1,149 pass) |
...
- **garu**: F1(정밀도/재현율) 기준, 자체 v15k 골드(95.8%) 및 NIKL MP(N/A)에서 보고.
