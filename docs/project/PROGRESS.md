...
## 마지막 업데이트: 2026-03-12 (Sprint 37 진행 중)

### 🎯 Sprint 37 - 85% 정확도 목표 (진행 중)
- **현재 정확도**: **78.0%** (세종 모드, sample.tsv 기준)
- **문장 정확도**: 38.0%
- **목표**: 85%+

### 품사별 현황 (2026-03-12 업데이트)
| 품사 | 정확도 | 샘플 수 | 변화 |
|------|--------|---------|------|
| JKB  | 83.3%  | 42      | - |
| NP   | 80.8%  | 26      | - |
...
| XSV  | 59.4%  | 64      | - |
| EP   | 56.2%  | 89      | - |
| EF   | 52.3%  | 258     | +3.9% (125차) |
| NNB  | 52.2%  | 23      | - |
| VV   | 50.4%  | 226     | - |
| MAG  | 38.7%  | 31      | - |
| VX   | 37.1%  | 35      | - |
| ETM  | 35.5%  | 31      | - |
| EC   | 28.2%  | 117     | +1.7% (124차) |

### Sprint 37 핵심 개선
1. **Token Accuracy**: 77.0% → **78.0%** (+1.0%)
2. **Jamo 정규화**: 종성 자모(U+11xx)를 호환 자모(U+31xx)로 통일 (124차)
3. **EF 정확도**: 48.4% → **52.3%** (+3.9%)
4. **EC 정확도**: 26.5% → **28.2%** (+1.7%)
5. **ㄴ다/는다 EF 규칙**: 문장 모든 위치에서 적용 (123차)
6. **ㄹ까요 EF 규칙**: 문장 끝에서 EC→EF 변환 (125차)
