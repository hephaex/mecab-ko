...
- **현재 정확도**: **81.5%** (세종 모드, sample.tsv 기준)
- **문장 정확도**: 51.7%
- **목표**: 85%+
...
|------|--------|---------|------|
| VX   | 77.1%  | 35      | +2.8% |
| NNB  | 65.2%  | 23      | +8.7% (118차) |
| VCP  | 63.2%  | 19      | +5.3% (119차) |
| EP   | 62.9%  | 89      | - (117차) |
| EF   | 61.2%  | 258     | +0.3% (120차) |
| EC   | 59.0%  | 117     | +0.9% |
| NP   | 88.5%  | 26      | - |
| JKO  | 76.9%  | 52      | - |
| VA   | 75.9%  | 87      | - |
...
### Sprint 37 핵심 개선
1. **Token Accuracy**: 81.1% → **81.5%** (+0.4%)
2. **NNB 정확도**: 56.5% → **65.2%** (+8.7%)
3. **VCP 정확도**: 57.9% → **63.2%** (+5.3%)
4. **EF 정확도**: 60.9% → **61.2%** (+0.3%)
5. **Sentence Accuracy**: 50.7% → **51.7%** (+1.0%)
6. **EP+EP 분리 규칙**: "셨" → "시/EP + 었/EP" (존칭+과거)
