# 현재 스프린트: Phase 25 - Sprint 37 (85% 정확도 + 안정화)

## 목표
Token Accuracy 81.0% → 85%+ 달성
- VX (보조용언): 74.3% → 85%+ (남은 패턴: 있다, 주다, 히다)
- EP (선어말어미): 55.1% → 70%+
- VCP (서술격조사): 57.9% → 75%+
- NNB (의존명사): 56.5% → 70%+

## 현재 정확도: 81.0% (Sample 데이터셋 기준, 2026-03-12)
...
### P0 (Critical)
- [ ] S37-01: EP (선어말어미) 정확도 개선
  - 현재 55.1% → 목표 70%+
  - 패턴: 았/었/겠/시 분리
  - sejong.rs: EP 보정 규칙 추가

- [ ] S37-02: NNB (의존명사) 정확도 개선
  - 현재 56.5% → 목표 70%+
  - 패턴: 것/수/등/바/데/지
  - 단위 의존명사: 원/분/시/개
...
- [ ] S37-04: VCP (서술격조사) 정확도 개선
  - 현재 57.9% → 목표 75%+
  - 패턴: NNG/NP + 이다/입니다/이야

### P2 (Medium)
- [ ] S37-05: XPN (접두사) 정확도 개선
  - 현재 66.7% → 목표 80%+
  - 패턴: 신/구/전/현/불

- [ ] S37-06: ETN (명사형어미) 정확도 개선
  - 현재 68.4% → 목표 80%+
  - 패턴: 기/음/ㅁ

### P3 (Low)
- [ ] S37-07: 정확도 평가 CI 자동화
- [ ] S37-08: crates.io 게시 준비

---

# 완료된 스프린트: Phase 24 - Sprint 36 (EC/VX 정확도 개선) ✅ 🎉

## 목표 (100% 달성!)
Token Accuracy 75.5% → 80%+ 달성 → **81.0% 달성!**

## 최종 성과
| 지표 | 시작 | 최종 | 변화 |
|------|------|------|------|
| Token Accuracy | 75.5% | 81.0% | +5.5% |
| VX | 20.0% | 74.3% | +54.3% |
| EC | 23.1% | 58.1% | +35.0% |

## 추가된 보정 규칙
- **111차**: NNG→VV+EC 변환 (가고, 보고, 하고)
- **112차**: NNP 싶어요 → VX+EF 분리
- **113차**: 복합 EC 병합 (고나서, 고나면)
- **114차**: 문장 중간 EF→EC (으면서, 면서)
- **32차 확장**: 피동사 패턴 (-이/-히/-리/-기)

---

# 완료된 스프린트: Phase 23 - Sprint 35 (Greedy Alignment 도입) ✅ 🎉

## 목표 (대폭 초과 달성!)
Token Accuracy 70% 달성 → **81.0% (aligned), 75.5% (standard)** 달성!

## 핵심 변경 사항

### Greedy Alignment 평가 알고리즘 도입
...
# 완료된 스프린트: Phase 22 - Sprint 33-34 (EC/ETM 정확도 개선) ✅

## Sprint 33 성과
- EC: 31.6% → 51.3% (+19.7%)
- ETM: 25.8% → 48.4% (+22.6%)
- Token Accuracy: 56.6% → 60.2%

## Sprint 34 성과
- Token Accuracy: 60.2% → 65.9%
- MAG: 51.6% → 80.6% (+29.0%)
- JKS: 53.8% → 63.5% (+9.7%)
