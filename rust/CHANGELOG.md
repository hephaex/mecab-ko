...
- **Tests**
  - 1,194 total tests (0 failures, 100% pass rate)
  - Async tokenizer tests added to CI async-tests job
  - 3 protection tests: verb_morpheme, compound_irregular, suffix_dep (Sprint 84)
...
- **Code Quality**
  - `corrections.rs` refactored: 13 sub-functions (max 1,020 lines, main fn 300 lines)
...
### Performance
- 1,194 tests passing, 0 failures
