# MeCab-Ko 도메인 사전: IT/기술 용어

IT 및 기술 분야의 전문 용어 사전입니다. 프로그래밍 언어, 프레임워크, 클라우드, AI/ML 등 다양한 IT 용어를 포함하고 있습니다.

## 개요

- **총 엔트리 수**: 283,670개 (중복 제거 완료)
- **카테고리**: 5개
- **포맷**: MeCab CSV 형식
- **인코딩**: UTF-8
- **목적**: 한국어 IT 기술 문서의 형태소 분석 정확도 향상

## 사전 구조

```
data/domain-dic/
├── it-terms/                          # IT 용어 사전 파일
