...
## 마지막 업데이트: 2026-03-06 (Sprint 28 시작)

### 🎯 Sprint 28 진행 중 - 정확도 45% 목표
- **현재 정확도**: **40.3%** (Sprint 27 기준 40.0% → 40.3%)
- **문장 정확도**: 22.3%
- **완전 일치 문장**: 67 / 300
- **목표**: 45%
...
## Sprint 28 진행 중 (2026-03-06)

### P0 (Critical)
- [ ] S28-01: 정확도 45% 달성
  - 현재: 40.3%
  - 목표: 45%+
  - EC merge 보정 추가 (하면서 패턴): 40.0% → 40.3% (+0.3%p)
- [ ] S28-02: npm mecab-ko-wasm v0.4.0 배포 (npm 토큰 필요)

### P1 (High)
- [ ] S28-03: JKS (주격조사) 정확도 개선 - 현재 23.1%
- [ ] S28-04: NNB (의존명사) 정확도 개선 - 현재 21.7%
...
### Git 커밋 이력 (Sprint 28)
- `2cedf56` - feat(sejong): Add EC merge correction and JKS fixes (40.0%→40.3%)
