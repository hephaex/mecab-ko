# 현재 스프린트: Phase 20 - Sprint 31 (MeCab 사전 개선)

## 목표
MeCab 사전 레벨 개선으로 정확도 55%+ 달성

## Sprint 31 작업 목록

### P0 (Critical)
- [ ] S31-01: 활용형 자동 생성기 구현
  - 위치: rust/crates/mecab-ko-dict-builder/src/inflect_gen.rs
  - 기능: 동사 기본형 → 40+ 활용형 자동 생성
  - 불규칙 동사 패턴 6종 처리 (ㄷ/ㅂ/ㄹ/르/ㅅ/ㅎ)
  - 모음조화 규칙 구현 (아/어)

- [ ] S31-02: Inflect.csv 확장 (20,000+ 엔트리)
  - 고빈도 동사 500개 × 40 어미 = 20,000 활용형
  - ETM (-는/-ㄴ/-ㄹ), EC (-고/-아서/-면), EF (-다/-요/-ㅂ니다)
  - 비용값 최적화 (-30000 ~ -500 범위)

### P1 (High)
- [ ] S31-03: ETM (관형형어미) 사전 확장
  - 현재: 25.8% → 목표: 45%+
  - VV+는/ㄴ/ㄹ 패턴 집중 추가
  - VA+ㄴ/은 패턴 추가
...
### P2 (Medium)
- [ ] S31-05: JKS (주격조사) 사전 확장
  - 현재: 28.8% → 목표: 45%+
  - 고빈도 명사+이/가 조합 100개+

- [ ] S31-06: EC (연결어미) 사전 확장
  - 현재: 37.6% → 목표: 55%+
  - VV+고/아서/면/니까/지만 패턴
