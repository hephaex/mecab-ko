# 현재 스프린트: Phase 18 - Sprint 29 (정확도 50% 목표)

## 목표
정확도 50% 달성, 저정확도 품사 집중 개선 (JKS, ETM, VX)

## Sprint 29 작업 목록

### P0 (Critical)
- [~] S29-01: 정확도 50% 달성
  - 시작: 45.0% (Sprint 28 완료)
  - 현재: 46.6% (+1.6%p)
  - 목표: 50%+
  - 접근: JKS/ETM/VX 개선, 동사 활용형 처리 강화
- [ ] S29-02: npm mecab-ko-wasm v0.4.0 배포 (npm 토큰 필요)
  - npm 토큰 확보 및 publish 실행

### P1 (High)
- [ ] S29-03: JKS (주격조사) 정확도 개선
  - 현재: 25.0%
  - 목표: 40%+
- [ ] S29-04: ETM (관형형어미) 정확도 개선
  - 현재: 25.8%
  - 목표: 40%+

### P2 (Medium)
- [ ] S29-05: VX (보조용언) 정확도 개선
  - 현재: 31.4%
  - 목표: 45%+
- [ ] S29-06: EC (연결어미) 정확도 개선
  - 현재: 35.9%
  - 목표: 45%+

### P3 (Low)
- [ ] S29-07: PyPI 실제 배포 (토큰 확보 시)
- [ ] S29-08: 문서 사이트 v0.5.0 갱신
