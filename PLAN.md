# 현재 스프린트: Phase 10 - Sprint 21 (정확도 50% 달성 & v0.4.0 준비)

## 목표
어미 분리 로직 구현으로 정확도 50% 달성, mecab-ko-dic v3.0 Phase 1, v0.4.0 준비
...
- [ ] S21-03: mecab-ko-dic v3.0 Phase 1 시작
  - 신조어 500+ 엔트리 추가 (neologism-sync 워크플로우 활용)
  - 커뮤니티 기여 엔트리 통합
  - 850K 엔트리 목표
- [ ] S21-04: 불규칙 활용 사전 구축
  - ㄷ불규칙, ㅂ불규칙, ㅅ불규칙, ㄹ불규칙
...
- [ ] S21-05: 복합명사 분해 정확도 향상
  ...
  - 분해 규칙 조정
- [ ] S21-06: 성능 회귀 테스트
  - 정확도 개선이 성능에 미치는 영향 측정
  - 3.5µs 이하 유지 목표

### P3 (Low)
- [ ] S21-07: v0.4.0 CHANGELOG 준비
  - 어미 분리 기능 문서화
  - mecab-ko-dic v3.0 Phase 1 변경사항
- [ ] S21-08: 커뮤니티 피드백 반영
