# 현재 스프린트: Phase 15 - Sprint 26 (정확도 35% & 배포 자동화)

## 목표
정확도 35% 달성, npm/PyPI 배포 자동화, 문서 사이트 갱신
...
- [ ] S26-01: 정확도 35% 달성
  - 현재: 30.4% (300문장, 세종 모드)
  - 목표: 35%+
  - 접근: XSV/VX/EP 패턴 강화, 사용자 사전 확장
- [ ] S26-02: npm mecab-ko-wasm v0.4.0 배포
  - npm 토큰 확보 및 publish 실행
  - README.md 업데이트

### P1 (High)
- [ ] S26-03: XSV (파생접미사) 정확도 개선
  - 현재: 9.4%
  - 목표: 25%+
- [ ] S26-04: VX (보조용언) 정확도 개선
  - 현재: 8.6%
  - 목표: 20%+

### P2 (Medium)
- [ ] S26-05: EP (선어말어미) 정확도 개선
  - 현재: 15.0%
  - 목표: 25%+
- [ ] S26-06: CI/CD 배포 자동화 개선
  - wasm-pack/npm publish 워크플로우
  - maturin/PyPI publish 워크플로우

### P3 (Low)
- [ ] S26-07: PyPI 실제 배포 (토큰 확보 시)
- [ ] S26-08: 문서 사이트 v0.4.0 갱신
