# 현재 스프린트: Phase 16 - Sprint 27 (정확도 40% & 배포 자동화)

## 목표
정확도 40% 달성, npm/PyPI 배포 자동화, 문서 사이트 갱신
...
- [ ] S27-01: 정확도 40% 달성
  - 현재: 35.2% (300문장, 세종 모드)
  - 목표: 40%+
  - 접근: 공백 연접 문제 해결, JKS/MAG/NNB 개선
- [ ] S27-02: npm mecab-ko-wasm v0.4.0 배포 (토큰 필요)
  - npm 토큰 확보 및 publish 실행
  - README.md 업데이트

### P1 (High)
- [ ] S27-03: JKS (주격조사) 정확도 개선
  - 현재: 21.2%
  - 목표: 35%+
  - 공백 연접 문제 해결이 핵심
- [ ] S27-04: MAG (부사) 정확도 개선
  - 현재: 22.6%
  - 목표: 35%+

### P2 (Medium)
- [ ] S27-05: NNB (의존명사) 정확도 개선
  - 현재: 21.7%
  - 목표: 35%+
- [ ] S27-06: CI/CD 배포 자동화 개선

### P3 (Low)
- [ ] S27-07: PyPI 실제 배포 (토큰 확보 시)
- [ ] S27-08: 문서 사이트 v0.5.0 갱신
