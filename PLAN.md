# 현재 스프린트: Phase 19 - Sprint 30 (정확도 55% 목표)

## 목표
정확도 55% 달성, 저정확도 품사 집중 개선 (ETM, JKS, EC)

## Sprint 30 작업 목록

### P0 (Critical)
- [ ] S30-01: 정확도 55% 달성
  - 시작: 50.1% (Sprint 29 완료)
  - 목표: 55%+
  - 접근: ETM/EC/JKS 개선, 숫자/시간 표현 처리
- [ ] S30-02: npm mecab-ko-wasm v0.4.0 배포 (npm 토큰 필요)

### P1 (High)
- [ ] S30-03: ETM (관형형어미) 정확도 개선
  - 현재: 25.8%
  - 목표: 40%+
- [ ] S30-04: JKS (주격조사) 정확도 개선
  - 현재: 28.8%
  - 목표: 40%+

### P2 (Medium)
- [ ] S30-05: EC (연결어미) 정확도 개선
  - 현재: 37.6%
  - 목표: 50%+
- [ ] S30-06: 숫자/시간 표현 처리 개선
  - 열시, 세시, 삼십분 등

### P3 (Low)
- [ ] S30-07: PyPI 실제 배포 (토큰 확보 시)
- [ ] S30-08: 문서 사이트 v0.5.0 갱신
