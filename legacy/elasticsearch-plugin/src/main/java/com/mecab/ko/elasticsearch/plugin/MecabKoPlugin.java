package com.mecab.ko.elasticsearch.plugin;

import com.mecab.ko.elasticsearch.analysis.MecabKoAnalyzerProvider;
import com.mecab.ko.elasticsearch.analysis.MecabKoTokenFilterFactory;
import com.mecab.ko.elasticsearch.analysis.MecabKoTokenizerFactory;
import com.mecab.ko.elasticsearch.loader.NativeLibraryLoader;
 ...
 *
 * Provides Korean morphological analysis capabilities using MeCab-Ko
 * with Nori-compatible interface.
 *
...
public class MecabKoPlugin extends Plugin implements AnalysisPlugin {
    ...
    public MecabKoPlugin() {
        logger.info("Initializing MeCab-Ko Elasticsearch Plugin");
        try {
            NativeLibraryLoader.load();
            String version = NativeLibraryLoader.getVersion();
            logger.info("MeCab-Ko native library loaded successfully (version: {})", version);
     ...
     *
     * @param analysisModule analysis module
